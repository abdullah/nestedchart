(function () {
    ...
    for (var i = 0; i < datasetfirst.length; i++) {
     ...
     canvas.onmousemove = function (e) {
          this.handleMouseMove(e,function (x) {
            this.config.onMouseMove(x)
          }.bind(this));
      }.bind(this)

      canvas.onmouseout = function (e) {
            this.config.mouseout(e)
      }.bind(this)
  ...
  Nestedpie.prototype.handleMouseMove = function (e,cb) {
    ...
    var mouseX = parseInt(e.clientX - e.target.getBoundingClientRect().left);
    var mouseY = parseInt(e.clientY - e.target.getBoundingClientRect().top);
